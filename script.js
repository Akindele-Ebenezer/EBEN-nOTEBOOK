...
boldBtn.addEventListener('click', boldSmallScreen);
...
italicBtn.addEventListener('click', italicSmallScreen);
...
underlineBtn.addEventListener('click', underlineSmallScreen);
